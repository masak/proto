...

{
    ...
    $t->dive_reset
        ...
        ->element_count_is('.koalitee a[href="/koalitee/Dist2"]'       => 1)
...

{
    ...
    $t->dive_reset->get_ok('/koalitee/Dist1')
        ->status_is(302)
